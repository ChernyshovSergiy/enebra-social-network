...
!(function (a, b) {
    ...
    function Ib(a, b, c) {
        ...
        if (e <= 0 || e == null) {
            if (((e = xb(a, b, f)), (e < 0 || e == null) && (e = a.style[b]), vb.test(e))) return e;
    ...
    const Rb = {
        '*': [
            function (a, b) {
                ...
                let g = (n.cssNumber[a] || (f !== 'px' && +d)) && Ob.exec(n.css(c.elem, a));
                let h = 1;
                let i = 20;
                if (g && g[3] !== f) {
                    (f = f || g[3]), (e = e || []), (g = +d || 1);
    ...
    function Vb(a, b, c) {
        ...
        if (n.isEmptyObject(m)) (j === 'none' ? tb(a.nodeName) : j) === 'inline' && (o.display = j);
        else {
    ...
    (n.fn.load = function (a, b, c) {
        ...
        return (
            ...
            n.isFunction(b) ? ((c = b), (b = void 0)) : b && typeof b === 'object' && (e = 'POST'),
            g.length > 0 &&
                n
