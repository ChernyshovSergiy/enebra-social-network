...
if (!window.jQuery) {
    (function (global, factory) {
        ...
        jQuery.extend = jQuery.fn.extend = function () {
            let options; var name; var src; var copy; var copyIsArray; var clone;
        ...
        let Sizzle =
            ...
            (function (window) {
                ...
                function Sizzle(selector, context, results, seed) {
                    let m; var i; var elem; var nid; var nidselect; var match; var groups; var newSelector;
                        ...
                        CHILD: function (type, what, argument, first, last) {
                            ...
                            return first === 1 && last === 0
                                ...
                                : function (elem, context, xml) {
                                    let cache; var uniqueCache; var outerCache; var node; var nodeIndex; var start;
                ...
                tokenize = Sizzle.tokenize = function (selector, parseOnly) {
                    let matched; var match; var tokens; var type;
                ...
                function matcherFromTokens(tokens) {
                    let checkContext; var matcher; var j;
                        var len = tokens.length;
        ...
        function buildFragment(elems, context, scripts, selection, ignored) {
            let elem; var tmp; var tag; var wrap; var contains; var j;
        ...
        jQuery.event = {
            ...
            dispatch: function (event) {
                ...
                let i; var j; var ret; var matched; var handleObj;
                    var handlerQueue = [];
            ...
            handlers: function (event, handlers) {
                let i; var matches; var sel; var handleObj;
                    var handlerQueue = [];
        ...
        function cloneCopyEvent(src, dest) {
            let i; var l; var type; var pdataOld; var pdataCur; var udataOld; var udataCur; var events;
        ...
        function domManip(collection, args, callback, ignored) {
            ...
            let fragment; var first; var scripts; var hasScripts; var node; var doc;
                var i = 0;
        ...
        jQuery.extend({
            ...
            clone: function (elem, dataAndEvents, deepDataAndEvents) {
                let i; var l; var srcElements; var destElements;
        ...
        (function () {
            let pixelPositionVal; var boxSizingReliableVal; var pixelMarginRightVal; var reliableMarginLeftVal;
        ...
        function curCSS(elem, name, computed) {
            let width; var minWidth; var maxWidth; var ret;
        ...
        function showHide(elements, show) {
            let display; var elem; var hidden;
                var values = [];
                var index = 0;
        ...
        function defaultPrefilter(elem, props, opts) {
            ...
            let prop; var value; var toggle; var tween; var hooks; var oldfire; var display; var checkDisplay;
                var anim = this;
                var orig = {};
                var style = elem.style;
        ...
        function propFilter(props, specialEasing) {
            let index; var name; var easing; var value; var hooks;
        ...
        jQuery.fn.extend({
            addClass: function (value) {
                let classes; var elem; var cur; var curValue; var clazz; var j; var finalValue;
                    var i = 0;
            ...
            toggleClass: function (value, stateVal) {
                ...
                return this.each(function () {
                    let className; var i; var self; var classNames;
        ...
        jQuery.fn.extend({
            val: function (value) {
                let hooks; var ret; var isFunction;
                    var elem = this[0];
        ...
        function ajaxConvert(s, response, jqXHR, isSuccess) {
            let conv2; var current; var conv; var tmp; var prev;
                var converters = {};
        ...
        jQuery.extend({
            ...
            ajax: function (url, options) {
                ...
                function done(status, nativeStatusText, responses, headers) {
                    let isSuccess; var success; var error; var response; var modified;
        ...
        jQuery.ajaxTransport(function (options) {
            let callback; var errorCallback;
        ...
        jQuery.fn.load = function (url, params, callback) {
            ...
            let selector; var type; var response;
                var self = this;
                var off = url.indexOf(' ');
        ...
        jQuery.offset = {
            setOffset: function (elem, options, i) {
                let curPosition; var curLeft; var curCSSTop; var curTop; var curOffset; var curCSSLeft; var calculatePosition;
